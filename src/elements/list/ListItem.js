...
const ListItem = props => {
  ...
  return (
    <Component delayPressIn={0}  delayPressOut={0}
    ...
    >
      <View style={[styles.wrapper, wrapperStyle && wrapperStyle]}>
        ...
        {badge && badge.value && !rightTitle && <Badge {...badge} />}
        {!hideChevron &&
            ...
            : <TouchableOpacity
              ...
              >
                <Icon
                  ...
                  size={24}
                  name={rightIcon.name || 'angle-right'}
