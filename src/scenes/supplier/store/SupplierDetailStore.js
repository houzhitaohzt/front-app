...
export class SupplierDetailStore {
    baseDetailone:Array<> = [
        ...
        {label:"来源",key:"cstmCrsekt",line:true},
        {label:"类型",key:"cstmType",space:true},
        ...
        {label:"WEB",key:"contactList",space:2,getValue:getValue,condition:90},
    ];
    ...
    getOne = id => {
        Api.get(Api.DS,"/vendor/app/getDetail",{id:id}).then(({data})=>{
...
export default new SupplierDetailStore();
